# -*- coding: utf-8 -*-
"""
Created on Tue Mar  6 19:30:07 2018
...
X_train, y_train = gd.read_data_formatted('train_struct_2000.txt')
params = gd.get_params()


p2b.optimize(params, X_train, y_train, 1000, 'solution_2000_distortion')



params = p2b.get_optimal_params('solution_2000_distortion')
