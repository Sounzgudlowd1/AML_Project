# -*- coding: utf-8 -*-
"""
Created on Tue Mar  6 19:23:58 2018
...
X_train, y_train = gd.read_data_formatted('train_struct_500.txt')
params = gd.get_params()


p2b.optimize(params, X_train, y_train, 1000, 'solution_500_distortion')



params = p2b.get_optimal_params('solution_500_distortion')
